...
longest Increasing subsequence is 0 2 6 9 13 15  and the length of the longest increasing subsequence is 6.</span></pre>
...
<p><strong><span style="font-size: 18px;">Constraint:</span></strong><br><span style="font-size: 18px;">1 &lt;= n &lt; = 1000<br>0 &lt;= arr[i] &lt;= 50000</span></p>
<p>&nbsp;</p></div>